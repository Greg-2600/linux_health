...
Generated: 2026-01-08 05:52:16 UTC

## System
- Hostname: debian
- OS: Debian GNU/Linux 12 (bookworm)
- Kernel: 6.1.0-18-amd64
- Uptime: up 1 year, 32 weeks, 1 day, 10 hours, 43 minutes
...
| --- | --- | --- | --- | --- |
| ✅ PASS | Disk usage | Root filesystem at 75% | Keep below 80% to avoid surprises | Storage |
| ✅ PASS | Memory | 45% available (44404 MiB of 96632 MiB) | No action | Memory |
| ⚠️ WARN | System load | Elevated load averages: 1m=4.13, 5m=4.29, 15m=4.55 | Check running processes with 'ps -eo pid,cmd,%cpu,%mem --sort=-%cpu | head' | CPU/Load |
...
```
PID CMD                         %CPU %MEM
3427923 ./Tdarr_Server              67.4  1.6
2937752 /usr/bin/mullvad-daemon -v  48.5  0.1
2796968 /opt/bazarr/venv/bin/python 29.4  0.4
4121639 /opt/readarr_audio_new/Read 26.5  2.9
2938615 /usr/bin/jellyfin --webdir= 14.1  0.7
 785419 /opt/Tdarr/Tdarr_Node/Tdarr 12.5  0.1
3975549 /usr/lib/firefox-esr/firefo 12.0  1.0
2675604 /opt/Radarr/Radarr -nobrows 11.8  0.8
2938605 /usr/bin/transmission-daemo  8.7  0.2
   9661 /usr/bin/gnome-software --g  7.9  0.7
2938665 /opt/Sonarr/Sonarr -nobrows  7.6  1.5
...
3641810 sshd: greg@notty             3.6  0.0
   7214 /usr/bin/gnome-shell         2.1  0.3
   6281 /usr/lib/xorg/Xorg vt2 -dis  2.0  0.1
```
...
```
Jan 05 17:40:56 debian sshd[3114607]: Accepted publickey for greg from 192.168.1.17 port 51672 ssh2: RSA SHA256:UAmoiYAmB9Cl12xWBc2cQWSnfkGfOtwwdtjJi1nqWdA
